  ...
  if (this.properties.MultiSelect === 2) {
    ...
    if (e.which === 1) {
      ...
      if (this.selectedItems.length > 1) {
        const index = this.selectedItems.indexOf(this.selectedItems.length - 1)
        this.selectedItems.splice(index, 1, startPoint)
        const firstIndex = this.selectedItems.indexOf(startPoint)
        let count = 0
        ...
        if (count > 2) {
          this.selectedItems.splice(firstIndex, 1)
        }
      }
    }
  }
